...
I'm a complete beginner, having started to learn to code in March 2026. I'm currently taking courses on [Boot.Dev](https://www.boot.dev?bannerlord=goblinacoded), on the Learn Python/Go Backend Path. I'm hoping to gain some knowledge and experience for a potential career change.

## About Me

My greatest passion has always been video games, and I love sharing that passion through my other hobby, streaming. I've always enjoyed puzzle solving, and have dabbled with soft-modding consoles, as well as a Raspberry Pi to make small emulation projects. I've also poked around with other people's streaming tools, and generally found I could understand them well enough to make changes, but I'd like to some day be able to do that myself. I don't have a specific goal in mind for now, I just want to enjoy the process of learning and see what I can do with some newfound skills.
